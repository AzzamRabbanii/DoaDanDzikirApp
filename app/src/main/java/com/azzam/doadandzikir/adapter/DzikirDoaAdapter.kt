package com.azzam.doadandzikir.adapter
...
import com.azzam.doadandzikir.DzikirDoa
import com.azzam.doadandzikir.R
...
class DzikirDoaAdapter(private val listDzikirDoa: ArrayList<DzikirDoa>) :
    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        //inisialisasi view dari layout row_item_dzikir_xml
